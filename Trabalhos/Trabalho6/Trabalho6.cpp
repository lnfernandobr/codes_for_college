...
void loadExternalTextures() {
    ...
    // Load the texture.
    image[0] = getBMPData("../../Textures/BK.bmp"); // le os arquivos de imagem

    // O glBindTexture permite criar ou usar uma textura nomeada.
    ...
    // Serve para alterar os parametros da textura
    ...
    /*
     * Para definir imagens de textura,usamos glTexImage2D.
     * Os argumentos descrevem os parâmetros da imagem da textura, como altura, largura, largura da borda, número do nível de detalhe
     * e número de componentes de cores fornecidos.
     * Os últimos três argumentos descrevem como a imagem é representada na memória.
     *
     * */
...
void setup(void) {
    ...
    glGenTextures(2, texture); /// Vai colocar no array textures os nomes das nossas texturas que é 2

    // Load external texture and generate and load procedural texture.
    loadExternalTextures();

    createChessboard(); // cria o tabuleiro de xadrez
