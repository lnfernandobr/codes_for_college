...
// g++ -o 4.59  4.59.cpp -lglut -lGL -lGLU -lm
// Sumanta Guha.
//////////////////////////////////////////////////////////////////////////////////////////////
// #include <openglut.h>
...
void  draw_cylinder(void) {
    ...
    static float R = 1; // Radius of hemisphere.
    static int p = 7; // Number of longitudinal slices.
    static int q = 11; // Number of latitudinal slices.
    ...
    for(int i = 0; i < p; i++) {
        ...
        for(int j = 0; j <= q; j++) {
            glVertex3f(
                    R * cos( (float)(j)/q * 2* PI ) ,
                    2.0 * PI * (float)(i+1) / p,
                    R * sin( (float)(j)/q *  2*PI )
            );
...
void Man::draw() {
    ...
    highlight||animateMode ? glColor3fv(highlightColor) : glColor3fv(lowlightColor);

    glPushMatrix();
        glTranslatef(0.0, upMove, forwardMove);

        if (highlight && !animateMode) {  // Torso begin.
            if (!selectedPart)
        ...
        if (highlight && !animateMode) // Torso end.
    ...
    glPushMatrix(); // Left upper and lower arm begin.
        ...
        if (highlight && !animateMode) // Left upper arm end.
            glColor3fv(highlightColor);
        ...
        glRotatef(partAngles[2],0.2, 0.0, 0.0);
        glTranslated(0.5, 2, 2);
        ...
        if (highlight && !animateMode) // Left lower arm end.
            glColor3fv(highlightColor);

    glPopMatrix(); // Left upper and lower arm end.


    glPushMatrix(); // Right upper and lower arm begin.

        if (highlight && !animateMode) { // Right upper arm begin.
            if (selectedPart == 3)
                glColor3fv(partSelectColor);
        }
        ...
        if (highlight && !animateMode) // Right upper arm end.
            glColor3fv(highlightColor);


        if (highlight && !animateMode) { // Right lower arm begin.
            if (selectedPart == 4)
                glColor3fv(partSelectColor);
        }
        ...
        glRotatef(partAngles[4],0.2, 0.0, 0.0);
        glTranslated(0.2, 2, 2);
        ...
        if (highlight && !animateMode) // Right lower arm end.
            glColor3fv(highlightColor);
    ...
    glPushMatrix(); // Left upper and lower leg with foot begin.
        ...
        if (highlight && !animateMode) // Left upper leg end.
            glColor3fv(highlightColor);
        ...
        if (highlight && !animateMode) // Left lower leg with foot end.
            glColor3fv(highlightColor);

    glPopMatrix(); // Left upper and lower leg with foot end.




    glPushMatrix(); // Right upper and lower leg with foot begin.

        if (highlight && !animateMode) { // Right upper leg begin.
            if (selectedPart == 7)
                glColor3fv(partSelectColor);
        }
        ...
        if (highlight && !animateMode) // Right upper leg end.
            glColor3fv(highlightColor);



        if (highlight && !animateMode) { // Right lower leg with foot begin.
            if (selectedPart == 8)
                glColor3fv(partSelectColor);
        }
        ...
        if (highlight && !animateMode) // Right lower leg with foot end.
            glColor3fv(highlightColor);

    glPopMatrix(); // Right upper and lower leg with foot end.
