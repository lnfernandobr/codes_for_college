...
//
// Compilar: g++ -o multipleLists  multipleLists.cpp -lglut -lGL -lGLU -lm
// 
// Sumanta Guha.
/////////////////////////////////////////////////////////////////////////////////////
...
static unsigned int junk[9] = {0, 2, 1, 3, 2, 11, 0, 2}; // Array of display list offsets.
...
void resize(int w, int h) {
   ...
   glLoadIdentity();
   glOrtho(-2.0, 150.0, 0.0, 150.0, -1.0, 1.0);
