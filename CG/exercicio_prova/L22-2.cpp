...
void drawScene(void) {
  ...
  glTranslatef(0.0, 0.0, 2.0);
  glScalef(1.0, 1.0, 1 + sin((PI / 180.0) * angle) / 2);
  glutWireCone(.3, .6, 15, 15);
  ...
  glScalef(1 + sin((PI / 180.0) * angle) / 2, 1 + sin((PI / 180.0) * angle) / 2, 1 + sin((PI / 180.0) * angle) / 2);
