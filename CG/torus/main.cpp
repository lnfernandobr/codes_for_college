   ...
   for(j = 0; j < q; j++) {
      ...
      glBegin(GL_TRIANGLE_STRIP);
         for(i = 0; i <= p; i++) {
            ...
            glVertex3f(
                  (r + R * cos( (float)(j+1)/q * PI * 2.0 ) ) * cos( 2.0 * (float)i/p * PI ),
                  R * sin( (float)(j+1) / q * PI * 2.0 ),
                  (r + R * cos( (float)(j+1)/q * PI * 2.0 ) ) * sin( 2.0 * (float)i/p * PI ) 
            );

            glVertex3f( 
                  (r+ R * cos( (float)j/q * PI*2.0 ) )* cos( 2.0 * (float)i/p * PI ),
                  R * sin( (float)j/q * PI*2.0 ),
                  ( r + R * cos( (float)j/q * PI*2.0 ) )* sin( 2.0 * (float)i/p * PI )
            );         
      }
