 ...
 *
 *
 * Experimento 3.13 Capitulo 3
 * Compilar: g++ -o lineStipple  lineStipple.cpp -lglut -lGL -lGLU -lm
 *
 */
...
void drawScene(void) {
   ...
   glRasterPos3f(30.0, 40.0, 0.0);
    ...
    switch(stippleID) {
        ...
        case 1: 
            glLineStipple(5, 0x0111); 
            writeBitmapString( (void*)font, "glLineStipple(1, 0x0001)");
            break;	  
